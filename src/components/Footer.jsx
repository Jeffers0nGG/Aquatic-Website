...
const Footer = () => {
    ...
    const socialLinks = [
        {
            name: 'Facebook',
            href: 'https://www.facebook.com/jeffers0ngg2f4st',
            icon: (
        ...
        // Keeping placeholders for others as not specified
        {
            name: 'Instagram',
            href: '#',
            icon: (
            ...
            <div className="container-custom px-4 py-12">
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 mb-8">
                    ...
                    <div className="lg:col-span-2">
                        <div className="flex items-center space-x-3 mb-4">
                            <div className="w-10 h-10 rounded-lg flex items-center justify-center shadow-glow-sm overflow-hidden bg-white/5">
                                <img src={logoImg} alt="Jeffers0n Aquatics Logo" className="w-full h-full object-contain" />
                            </div>
                ...
                <div className="pt-8 border-t border-white/10">
                    ...
                    <div className="flex flex-col md:flex-row items-center justify-between text-sm text-gray-500">
                        <p>© {currentYear} Jeffers0n Aquatics. All rights reserved.</p>
